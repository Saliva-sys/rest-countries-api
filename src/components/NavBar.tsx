...
const NavBar: React.FC<NavBarProps> = ({onSwitch, darkMode}) => {
    ...
    return (
        ...
        <nav className={`navbar flex items-center justify-between ps-[2rem] md:ps-[5rem] pt-[3.745rem] md:pt-[1.3rem] pe-[2.1rem] md:pe-[5rem] pb-[3.6rem] md:pb-[1.45rem] shadow-[0px_4px_10px_rgba(0,0,0,0.1)] `}
        >
